...
# Lives as long as the TenaAgent process. Concepts don't disappear, and a freshly
...
class OpenmrsWriter:
    ...
    def __init__(
        ...
        *,
        ...
        # operator-supplied Basic creds so the TenaAgent service can talk to
    ...
    def is_concept_seeded(self, uuid: str) -> bool:
        ...
        a TenaAgent session), so concurrent reads are safe behind a single lock.
        """
        if not uuid:
            return False
