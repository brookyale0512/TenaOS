...
class ReportDraftStore:
    ...
    def update_draft(
        ...
        *,
        ...
        clear_last_query: bool = False,
        clear_last_result: bool = False,
        clear_last_run_at: bool = False,
        ...
        updated = ReportDraft(
            ...
            last_query=None if clear_last_query else (last_query if last_query is not None else existing.last_query),
            last_result=None if clear_last_result else (last_result if last_result is not None else existing.last_result),
            last_run_at=None if clear_last_run_at else (last_run_at if last_run_at is not None else existing.last_run_at),
