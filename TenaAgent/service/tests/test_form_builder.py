...
from tena_agent_service.form_builder import (  # noqa: E402
    BasketField,
    BasketSection,
    ConceptBasket,
    FormMeta,
...
class ToolLoopTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.loop = FormBuilderToolLoop(
            ...
            llm=_FakeVllm(),  # type: ignore[arg-type]
    ...
    def test_na_clinical_concept_renders_as_yes_no_radio_in_schema(self) -> None:
        ...
        from tena_agent_service.form_builder import BasketField, BasketSection, ConceptBasket, FormMeta, basket_to_schema  # noqa: WPS433
