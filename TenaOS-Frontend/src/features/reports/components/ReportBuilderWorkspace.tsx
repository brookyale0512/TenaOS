...
import { useTenaAgentHealth } from "@/features/forms/hooks/useFormBuilder";
import {
...
export function ReportBuilderWorkspace() {
  ...
  }, [routeDraftId, draftId, tenaAgentReady, cielReady, gemmaReady]);
        ...
        <div className="p-4 md:p-6 space-y-3">
          {tenaAgentHealth.isError && (
            <ErrorState
              ...
              onRetry={() => tenaAgentHealth.refetch()}
            />
          )}
