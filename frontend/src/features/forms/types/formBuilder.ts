// Types mirroring the CDS service form_builder data shapes.
//
// These map 1:1 to the Python dataclasses in
// `cds/service/cds_service/form_drafts.py` and
// `cds/service/cds_service/form_builder.py`. Keep them in sync.
