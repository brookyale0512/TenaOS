// Types mirroring the CDS service report-builder data shapes.
// Keep in sync with cds/service/cds_service/report_drafts.py
// and cds/service/cds_service/report_builder.py.
